...
7. CLIENT_ID : XXX #random 72+ userid
    ...
    ```shell
    k -n security exec authelia-59f9db8b6d-pvmlr -- authelia crypto rand --length 72 --charset rfc3986
    ```

8. CLIENT_SECRET : XXX #random 72+ pass
    ```shell
    k -n security exec authelia-59f9db8b6d-pvmlr -- authelia crypto hash generate pbkdf2 --variant sha512 --random --random.length 72 --random.charset rfc3986
    ```
